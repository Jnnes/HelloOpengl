...
int main()
{
    ...
    // --------------------
    GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "13_Blend", NULL, NULL);
    if (window == NULL)
    {
    ...
    unsigned int transparentTexture = loadTexture(getResPath("/textures/window.png").c_str());
